...
parser.add_argument("--train_mode", dest="train_mode", type=int, default=0, 
...
parser.add_argument("--checkpoint_path",dest="checkpoint_path", type=str, default="./model/", 
                    help="保存模型断点的目录")
# 验证/测试
parser.add_argument("--model_dir", dest="model_dir", type=str, default="./model2/m_d6_a1_s0.619_r17.388_t21.0_wd_e715.ckpt-715",
