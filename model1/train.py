    ...
    with tf.Session(config=tf_config) as sess:
        ...
        while epoches < args.num_epoch:
            ...
            if batches % args.evaluate_steps == 0:
                ...
                train_value['results'].append(results)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--do_predict', '-predict', action='store_true', default=True, help='Whether to run predicting')
    ...
    parser.add_argument('--random_seed', '-rs', type=int, default=7, help='Random seed')
