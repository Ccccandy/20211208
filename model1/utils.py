...
class DataProcessor_LSTM(object):
    ...
    def __init__(self, 
        ...
        inputs_seq = []
        # seq：inputs_seq中的每句话的每个字符转化为index
        # inputs_seq：将所有seq放进来
        ...
        outputs_seq = []
        # seq：inputs_seq中的每句话的每个BIO转化为index
        # inputs_seq：将所有seq放进来
    ...
    def get_batch(self, batch_size):
        ...
        while (len(inputs_seq_batch) < batch_size) and (not self.end_flag):
            ...
            inputs_seq_len_batch.append(len(self.inputs_seq[p]))    # 每个对话的长度
