...
class MyModel(object):
    ...
    def __init__(self, 
        ...
        with tf.variable_scope('encoder2'):
            ...
            add = tf.div(add, tf.cast(self.num,dtype=tf.float32)) #(32,1,300)。。平均
            add = tf.tile(add,[1,self.num,1]) #(32,50,300)
        ...
        with tf.variable_scope('type_projection'):
            ...
            probs_type = tf.nn.softmax(logits_type, axis=-1)
